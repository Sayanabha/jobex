  ...
  return (
    <div className="space-y-8">
      <section className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-[32px] border border-border bg-card p-8 shadow-glow">
          ...
          <div className="mt-10 rounded-3xl border border-border bg-muted p-5">
            ...
            {skillGap ? (
              <div className="space-y-5">
                ...
                {Object.entries(skillGap.missing_skills).map(([level, items]) => (
                  <div key={level} className="rounded-2xl border border-border bg-muted p-4">
            ...
            {roadmap ? (
              <div className="space-y-4">
                {roadmap.timeline.map((item) => (
                  <div key={`${item.week}-${item.focus}`} className="grid gap-4 rounded-3xl border border-border bg-muted p-5 lg:grid-cols-[72px_1fr]">
                    <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-primary/10 font-display text-xl text-primary">
                      {item.week}
                    </div>
                    <div>
                      <h4 className="font-display text-xl text-foreground">{item.focus}</h4>
            ...
            {projects ? (
              <div className="grid gap-4 lg:grid-cols-3">
                {projects.projects.map((project) => (
                  <div key={project.title} className="rounded-3xl border border-border bg-muted p-5">
              ...
              <div className="grid gap-4 lg:grid-cols-[0.9fr_1.1fr]">
                <div className="rounded-3xl border border-border bg-muted p-5">
                  <div className="flex items-center gap-2">
                    ...
                    <h4 className="font-display text-xl text-foreground">Switch snapshot</h4>
                  </div>
                ...
                <div className="rounded-3xl border border-border bg-muted p-5">
                  <h4 className="font-display text-xl text-foreground">Recommended plan</h4>
